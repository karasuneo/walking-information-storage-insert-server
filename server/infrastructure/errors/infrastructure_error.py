...
class InfrastructureErrorType(Enum):
    NOT_FOUND_BUILDING = "NOT_FOUND_BUILDING"
    ...
    NOT_FOUND_COORDINATE = "NOT_FOUND_COORDINATE"
    ...
    COORDINATE_DB_ERROR = "COORDINATE_DB_ERROR"
    WIFI_FINGERPRINT_DB_ERROR = "WIFI_FINGERPRINT_DB_ERROR"
